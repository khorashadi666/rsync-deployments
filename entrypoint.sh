...
# Do deployment
sh -c "rsync -avz $EXCLUDE -e 'ssh -i $SSH_PATH/deploy_key -p 22 root@212.33.205.190' $CHOWN ${GITHUB_WORKSPACE}$SOURCE root@212.33.205.190:/lingemy/project/school/prod/code/wp-test"
